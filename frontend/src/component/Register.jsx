...
//       style={{ backgroundImage: "url('/src/assets/register-bg.jpg')" }}
//     >
//       {/* Dark overlay for contrast */}
//       <div className="absolute inset-0 bg-black/50 backdrop-blur-sm"></div>

//       {/* Register Card */}
//       <div className="relative w-full max-w-md bg-white/10 backdrop-blur-lg border border-yellow-400/30 shadow-2xl rounded-2xl p-8 space-y-6 text-white overflow-hidden group z-10">
        
//         {/* Neon glowing background effects */}
//         <div className="absolute -top-12 -right-12 w-48 h-48 bg-yellow-500/20 rounded-full blur-3xl group-hover:scale-110 transition-transform"></div>
...
//           <div>
//             <label className="block text-sm font-semibold text-gray-200">Mobile</label>
//             <input
//               type="text"
//               name="mobile"
